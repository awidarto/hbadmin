...
class DoctorController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            array('Name',array('search'=>true,'sort'=>false)),
            array('Specialization',array('search'=>true,'sort'=>true)),
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            array('name',array('kind'=>'text','query'=>'like','pos'=>'both','callback'=>'namePic','show'=>true)),
            array('specialization',array('kind'=>'text','query'=>'like','pos'=>'both','show'=>true)),
